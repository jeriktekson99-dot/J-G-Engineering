...
export default function GetStartedPage({ onScrollToSection }: GetStartedPageProps) {
  ...
  const faqs: FaqItem[] = [
    ...
    },
    {
      ...
      num: "06",
      category: "Compliance",
      question: "What safety protocols are practiced on J/G active construction project fields?",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.fullName || !formData.companyEmail || !formData.projectScope) {
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between items-start gap-4">
            <div>
              ...
              <p className="font-sans text-gray-600 text-sm sm:text-base max-w-2xl mt-4 leading-relaxed">
                Connect with our estimating desk and engineering team to check calculations and schedule dispatch.
              </p>
            </div>
            <div className="font-mono text-xs text-gray-400 shrink-0">
              [ESTIMATING_DESK v2026]
            </div>
          </div>
        </div>
      </section>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="bg-[#fafafa] border border-black p-4 w-full text-left font-mono text-xs text-black mb-8 overflow-x-auto max-w-sm mx-auto">
                    ...
                    {formData.companyName && <div>COMPANY: {formData.companyName}</div>}
                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-left">
                  ...
                  <div>
                    <label htmlFor="fullName" className="block text-xs font-mono font-black text-black uppercase tracking-wider mb-2">
                      Full Name <span className="text-industrial-red">*</span>
                    </label>
                    <input
                      type="text"
                      id="fullName"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="companyEmail" className="block text-xs font-mono font-black text-black uppercase tracking-wider mb-2">
                        Company Email <span className="text-industrial-red">*</span>
                      </label>
                      <input
                        type="email"
                        id="companyEmail"
                        ...
                        className="w-full bg-white border border-black px-4 py-3 text-sm rounded-none focus:outline-none focus:ring-2 focus:ring-[#1B49B8] text-black placeholder-gray-400 font-sans"
                        placeholder="e.g. projects@vancecorp.com"
                      />
                    </div>

                    <div>
                      <label htmlFor="companyName" className="block text-xs font-mono font-black text-black uppercase tracking-wider mb-2">
                        Company Name
                      </label>
                      <input
                        type="text"
