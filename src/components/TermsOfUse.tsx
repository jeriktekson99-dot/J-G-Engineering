          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between items-start gap-4 text-left">
            <div>
              ...
              <p className="font-sans text-gray-600 text-sm sm:text-base max-w-2xl mt-4 leading-relaxed">
                Rules, disclaimers, and guidelines regulating digital interaction with J/G Construction Services platforms.
              </p>
            </div>
            <div className="font-mono text-xs text-gray-400 shrink-0 border border-gray-200 bg-white px-3 py-1">
              [GOVERNED_BY_PH_LAW]
            </div>
          </div>
        </div>
      ...
      <section className="w-full text-left pt-12 pb-0 bg-white">
        ...
        <div className="w-full border-b border-gray-100 py-12 px-6 sm:px-12 md:px-20 lg:px-32 hover:bg-gray-50/30 transition-colors">
          <div className="w-full space-y-4">
            ...
            <p className="font-sans text-gray-600 text-sm leading-relaxed">
              The copy, structural layout, graphics, digital blueprint templates, logo designations, case study narratives, and overall content structure displayed on this website are protected under applicable copyrights, trademarks, and other proprietary rights (including but not limited to the Intellectual Property Code of the Philippines).
            </p>
            ...
            <div className="space-y-3 font-sans text-xs text-gray-700">
              <div className="flex gap-2.5 items-start">
                <div className="h-1.5 w-1.5 bg-industrial-red shrink-0 mt-1.5"></div>
                <div>
                  <strong>Limited License:</strong> You are granted a non-exclusive, non-transferable, revocable license to access and view the site content strictly for personal, non-commercial utilization.
                </div>
              </div>
              <div className="flex gap-2.5 items-start">
                <div className="h-1.5 w-1.5 bg-engineering-blue shrink-0 mt-1.5"></div>
                <div>
                  <strong>Prohibitions:</strong> You may not copy, redistribute, republish, or duplicate any technical designs, blueprint visualizations, or text parameters from this site without explicit written clearance from the corporate management team of J/G Construction Services.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full border-b border-gray-100 py-12 px-6 sm:px-12 md:px-20 lg:px-32 hover:bg-gray-50/30 transition-colors">
          <div className="w-full space-y-4">
            <h3 className="font-display font-black text-lg sm:text-xl text-black uppercase tracking-tight">
              4. Technical Disclaimers & Preliminary Estimates
            </h3>
            <p className="font-sans text-gray-700 text-sm sm:text-base leading-relaxed">
        ...
        <div className="w-full bg-gray-50 py-14 px-6 sm:px-12 md:px-20 lg:px-32">
          <div className="w-full space-y-4">
            <h3 className="font-display font-black text-xl text-black uppercase tracking-tight">
              9. Contact and Administrative Information
            </h3>
