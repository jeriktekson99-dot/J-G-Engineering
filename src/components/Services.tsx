            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-sans text-sm leading-relaxed mb-6 text-left">
                    {svc.description}
                  </p>
                </div>

                {/* Technical structural bullet proofing */}
                <div className="border-t border-gray-100 pt-4 mt-4">
                  <span className="block font-mono text-[10px] text-gray-500 uppercase tracking-widest text-left mb-3">
                    Deliverables:
                  </span>
                  <ul className="space-y-2 text-left">
                    {svc.bulletPoints.map((pt, pIdx) => (
                      <li key={pIdx} className="flex items-start gap-2 text-xs text-gray-700">
                        <CheckCircle2 className="h-3.5 w-3.5 text-engineering-blue mt-0.5 shrink-0" />
                        <span>{pt}</span>
                      </li>
                    ))}
                  </ul>
